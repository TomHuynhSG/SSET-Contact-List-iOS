...
var contacts: [Contact] = [
    ...
    Contact(name: "Tri Dang", email: "tri.dangtran@rmit.edu.vn", phone: "06786566", imageName: "tri-dang", locationCoordinate: CLLocationCoordinate2D(latitude: 10.79437079611712, longitude: 106.80394039521534)),
    ...
    Contact(name: "Minh Vu", email: "minh.vu@rmit.edu.vn", phone: "0934634534534", imageName: "minh-vu", locationCoordinate: CLLocationCoordinate2D(latitude: 10.949713377874208, longitude: 106.8479555990988)),
    ...
    Contact(name: "Khuong Nguyen", email: "khuong.nguyen@rmit.edu.vn", phone: "09453346y3", imageName: "khuong-nguyen", locationCoordinate: CLLocationCoordinate2D(latitude: 10.745642963019284, longitude: 106.57460623743862)),
